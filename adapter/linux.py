...
class LinuxAdapter(BaseAdapter):
    ...
    def click_element(self, window_title: str, control_identifier: str) -> Optional[str]:
        """Agent instruction: Agent uses click_element for automation tasks. control_identifier is index-based 'ID' from get_all_controls."""
        if not HAS_PYATSPI:
    ...
    def read_text(self, window_title: str, control_identifier: str) -> Optional[str]:
        """Agent instruction: Agent uses read_text for automation tasks. control_identifier is index-based 'ID'."""
